...
class MpaAtlasIntermediatePipe(IntermediateBasePipe):
    ...
    extract_params = [
        ExtractParams(
            source="https://storage.cloud.google.com/vector-data-raw/ProtectedSeas/ProtectedSeas_06142023.csv",
        ),
        ExtractParams(
            source="https://storage.cloud.google.com/vector-data-raw/ProtectedSeas/ProtectedSeas_ProtectedSeas_06142023_shp_ProtectedSeas_06142023_shp.zip",
        ),
    ]
