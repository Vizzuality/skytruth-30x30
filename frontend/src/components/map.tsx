  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 right-6 z-10 flex flex-col">
        <button
          type="button"
          className="block rounded-lg rounded-b-none bg-black p-1 text-white ring-offset-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-70"
        ...
        <button
          type="button"
          className="block rounded-lg rounded-t-none bg-black p-1 text-white ring-offset-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-70"
          onClick={() =>
